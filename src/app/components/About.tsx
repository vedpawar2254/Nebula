...
const About: React.FC = () => {
  ...
  return (
    <section className="min-h-screen w-full py-12 sm:py-16 md:py-20 px-4 sm:px-6 lg:px-8">
            ...
            <article key={index} className="text-center">
              ...
              <div className="flex flex-wrap justify-center gap-6 sm:gap-8 px-4">
                {section.members.map((member, memberIndex) => (
                  <div key={memberIndex} className="w-full sm:w-1/2 md:w-auto max-w-xs text-center group">
