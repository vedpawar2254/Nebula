...
const Leaderboard: React.FC<LeaderboardProps> = ({
  ...
  const getMedalIcon = (rank: number) => {
    ...
    if (rank === 1)
      return <FaMedal style={{ ...style, color: "#facc15" }} title="Gold Medal" />;
    if (rank === 2)
      return <FaMedal style={{ ...style, color: "#d1d5db" }} title="Silver Medal" />;
    if (rank === 3)
      return <FaMedal style={{ ...style, color: "#fb923c" }} title="Bronze Medal" />;
    return null;
  };
